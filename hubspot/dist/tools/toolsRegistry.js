...
import { ListEmailTemplatesTool } from './emails/listEmailTemplatesTool.js';
import { ListEmailEventsTool } from './emails/listEmailEventsTool.js';
import { ListMessageTemplatesTool } from './emails/listMessageTemplatesTool.js';
import { LogEmailEngagementTool } from './emails/logEmailEngagementTool.js';
import { SendMarketingEmailTool } from './emails/sendMarketingEmailTool.js';
...
registerTool(new ListEmailTemplatesTool());
registerTool(new ListEmailEventsTool());
registerTool(new ListMessageTemplatesTool());
registerTool(new LogEmailEngagementTool());
registerTool(new SendMarketingEmailTool());
